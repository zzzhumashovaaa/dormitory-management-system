    ...
    <DashboardLayout>
      <div className="mb-8">
        ...
        <p className="text-gray-500">
          Real-time overview of dormitory daily operations
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-4 gap-5 mb-8">
        ...
        <Link
          ...
          className="bg-white p-6 rounded-2xl shadow hover:bg-gray-50 transition"
        >
          <p className="text-gray-500">
            Handle
          </p>
          ...
          {applications.length === 0 ? (
            ...
            <div className="space-y-3">
              {applications.slice(0, 5).map((app) => (
                <Link
                  key={app.id}
                  to={`/manager/applications/${app.id}`}
          ...
          {complaints.length === 0 ? (
            ...
            <div className="space-y-3">
              {complaints.slice(0, 5).map((complaint) => (
                <Link
                  key={complaint.id}
                  to={`/manager/complaints/${complaint.id}`}
                  className="block border rounded-xl p-4 hover:bg-gray-50"
                >
                  <div className="flex justify-between gap-4">
                    <div>
